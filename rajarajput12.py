...
{1}$$ |  $$ |$$ |  $$ |$$ |\$$\  $$ |      $$\   $$ |$$ |  $$ |
{0}$$ |  $$ |$$ |  $$ |$$ | \$$\ $$$$$$$$\ \$$$$$$  |$$ |  $$ |
{0}\__|  \__|\__|  \__|\__|  \__|\________| \______/ \__|  \__|
...
def show_termux_message():
    ...
    termux_message = r"""
╔═════════════════════════════════════════════════════════════╗
║  {0}N4M3       : MR.RAKESH KUMAR                   
║  {1}RULL3X     : BIHAR FIRE RUL3X-BROKEN-NADEEM
║  {1}RULL3X     : BIHAR FIRE RUL3X
║  {2}BR9ND      : MR.RAKESH INSIDE
║  {0}GitHub     : https://github.com/RAKESH-420
║  {1}WH9TS9P    : +994 4053226
╚═════════════════════════════════════════════════════════════╝
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.GREEN + f"└────────────────────────────────────────────────────────────────────┘\n")
                print(Fore.YELLOW + "\033[1;32m<<========❌✨🌐 OWNER RAKESH 😏⚔️⚜️🫢 KUMAR ✨❌✨🌐😈🛠️✨======>>")
                print("\n" + ("─" * 80) + "\n")
            except requests.exceptions.RequestException:
...
def main():
    ...
    pastebin_url = "https://pastebin.com/raw/0HnzMZVx"  # URL of the pastebin containing the password
